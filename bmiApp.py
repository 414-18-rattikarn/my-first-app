...
height_cm = st.number_input("กรอกข้อมูลส่วนสูงของคุณ (เซนติเมตร):", min_value=1.0, value=1.0

#ส่วนที่ 3 สร้างปุ่มกดคำนวณ
if st.bottom("คำนวณค่า BMI")
...
st.divider()
st.write("นางสาวรัตติกาญ เกิดฉาย เลขที่ 5 ม.4/14")       
